...
class Dataset:
	...
	def arrange_data(self):
		with open(self.filename) as f:
			...
			self.numeric_attrs = [True,True,False,True,True,True,True,True,True,True,False,True,True,False]
...
def main():
	now = time.time()
	target = " winner"
	train_filename = "btrain (1).csv"
	validation_filename = "bvalidate.csv"
